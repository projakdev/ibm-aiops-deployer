...
echo ""
    ...
    echo '{\"unique_id\": \"'$JOB_ID'\",\"description\": \"Automatically created by Skillion TechTeam scripts\",\"parameters\": {\"file\": \"/opt/ibm/netcool/asm/data/file-observer/custom-topology.txt\"}}' > /tmp/custom-topology-observer.txt
    echo '{"unique_id": "'$JOB_ID'","description": "Automatically created by Skillion TechTeam scripts","parameters": {"file": "/opt/ibm/netcool/asm/data/file-observer/custom-topology.txt"}}' > /tmp/custom-topology-observer.txt
