...
Author: Niklaus Hirt (akshay@skillion.in)
"""
...
def loadTopology() -> str:
    ...
    echo '{\"unique_id\": \"demoui-custom-topology\",\"description\": \"Automatically created by Skillion TechTeam scripts\",\"parameters\": {\"file\": \"/opt/ibm/netcool/asm/data/file-observer/custom-topology.txt\"}}' > /tmp/custom-topology-observer.txt
